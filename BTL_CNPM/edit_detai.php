...
/* Căn chỉnh biểu tượng lịch nếu cần */
...
<body>
                            ...
                            <div class="row">
                                ...
                                <div class="input-field col s6">
                                    <select name="TrangThai" required>
                                        <option value="Chưa bắt đầu" <?= $result->TrangThai == "Chưa bắt đầu " ? "selected" : "" ?>>Chưa bắt đầu</option>
                                        <option value="Đang làm việc" <?= $result->TrangThai == "Đang làm việc " ? "selected" : "" ?>>Đang làm việc</option>
                                        <option value="Đã hoàn thành" <?= $result->TrangThai == "Đã Hoàn thành" ? "selected" : "" ?>>Đã Hoàn thành</option>
    ...
    <div class="input-field col s6">
        ...
        <input id="NgayBatDau" name="NgayBatDau" type="date" value="<?= date('Y-m-d', strtotime($result->NgayBatDau)) ?>" required>
    </div>
    <div class="input-field col s6">
        <label for="NgayKetThuc">Ngày Kết Thúc</label>
        <input id="NgayKetThuc" name="NgayKetThuc" type="date" value="<?= date('Y-m-d', strtotime($result->NgayKetThuc)) ?>" required>
    </div>
</div>
                            <div class="row">
                                <div class="input-field col s6">
